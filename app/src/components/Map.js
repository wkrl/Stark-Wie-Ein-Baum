...
/**
 * Komponente die eine Google Maps Karte mit den Bäumen als Features anzeigt.
 * Die Icons für die Features werden dynamisch geladen und öffnen `<TreeInfoBox>` nach einem Klick.
 * Der Standort des Nutzers wird zudem abgefragt und auf der Karte als roter Pin angezeigt.
 *
 * **Parameter**:
 */
const Map = () => {
